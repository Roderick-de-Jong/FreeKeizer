...
class IOServices
{
	 ...
	 */
	virtual void readPlayers(PlayerList* playerList);
	 ...
	 */
	virtual Round* readRound(unsigned int r);
	 ...
	 */
	virtual void writeRankingDocument(Competition* competition, unsigned int round);
